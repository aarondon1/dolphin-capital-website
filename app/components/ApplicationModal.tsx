...
const FORMSPREE_APPLICATION_ENDPOINT = "https://formspree.io/f/manbgjow"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sanitizedData = {
        ...
        gpa: formData.gpa ? Number.parseFloat(formData.gpa).toString() : "",
      ...
      const response = await fetch(FORMSPREE_APPLICATION_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...sanitizedData,
          _subject: `Dolphin Capital — New Application from ${sanitizedData.name}`,
      ...
      setIsSubmitting(false)
      setFormErrors({ general: "Failed to submit application. Please try again." })
    }
  }
